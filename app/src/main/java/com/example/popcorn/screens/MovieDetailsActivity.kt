...
//import com.example.mhsflix.adapters.VideosController
import com.example.popcorn.data.MovieDetailsViewModel
import com.example.popcorn.data_models.Movie
import com.example.popcorn.data_models.Video
import com.example.popcorn.databinding.ActivityMovieDetailsBinding
import com.example.popcorn.extensions.*
import com.example.popcorn.extensions.getBackdropUrl
import com.example.popcorn.extensions.getReleaseYear
import com.example.popcorn.extensions.getRunTime
import com.example.popcorn.extensions.toMediaBsData
import com.example.popcorn.network.models.MovieDetailsResponse
...
class MovieDetailsActivity : BaseActivity() {
    ...
    private fun setupUI() {
        ...
        binding.shareLl.setOnClickListener{share()}
        ...
        binding.overviewText.setOnClickListener {
            binding.overviewText.maxLines = 10
            binding.overviewText.isClickable = false
        }
    ...
    private fun updateDetails(details: MovieDetailsResponse) {
        ...
        binding.yearText.text = details.getReleaseYear()
        binding.runtimeText.text = details.getRunTime()
        binding.ratingText.text = details.voteAverage.toString()
